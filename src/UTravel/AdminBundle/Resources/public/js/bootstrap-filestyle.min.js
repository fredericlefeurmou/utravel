(function(c){
        ...
        b.prototype={
            ...
            size:function(d){
                if(d!==undefined){
                    ...
                    f.removeClass("btn-lg btn-sm");e.removeClass("input-lg input-sm");
                    if(d!="nr"){
        ...
        var a=c.fn.filestyle;c.fn.filestyle=function(e,d){
            var f="",g=this.each(function(){
                if(c(this).attr("type")==="file"){
                    ...
                    if(!h){j.data("filestyle",(h=new b(this,i)));h.constructor()}if(typeof e==="string"){f=h[e](d)}}});
    ...
    c(function(){
        c(".filestyle").each(function(){
            ...
            size:e.attr("data-size"),buttonText:e.attr("data-buttonText"),
            buttonName:e.attr("data-buttonName"),iconName:e.attr("data-iconName")
            };
            e.filestyle(d)
        })
    })
...
$(":file").filestyle({icon: false, buttonBefore: true, buttonText: "Charger l'image"});